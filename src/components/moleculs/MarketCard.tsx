...
export interface MarketCardProps {
  symbol: string;
  last: number | string;          // sesuaikan dgn data API kamu
  percentChange: number | string; // sama: string "0.45%" atau numeric
  direction: 'up' | 'down' | 'neutral' | string; // tambah string jika belum konsisten
}
...
export default function MarketCard({
  ...
  const iconClass =
    dir === 'up' ? 'fa-angles-up' : dir === 'down' ? 'fa-angles-down' : 'fa-minus';
